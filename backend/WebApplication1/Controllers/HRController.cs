...
public async Task<IActionResult> RequestDocument([FromBody] DocumentRequestDto request)
{
    var employee = await _context.Employees.FirstOrDefaultAsync(e => e.EmployeeIdentifier == request.EmployeeId);
    ...
    var notification = new Notification
    {
        ...
        Message = $"You have a new document request: {request.RequestText}",
        IsRead = false,
